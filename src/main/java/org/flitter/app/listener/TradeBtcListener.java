...
public class TradeBtcListener implements ApplicationListener<ApplicationReadyEvent> {
        ...
        try {
            client.tradeStream("btcusdt", ((event) -> {
                ...
                try {
                    ...
                    utils.saveLogs("Error", "BTC Stream", "Invalid JSON: missing required keys");
                }
            ...
            Utils utils = new Utils();
            utils.saveLogs("Error", "BTC Stream", "Connection error");
        }
    }
