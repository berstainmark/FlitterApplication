...
public class TradeDogListener implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(ApplicationReadyEvent events) {
        ...
        try {
            client.tradeStream("dogeusdt", ((event) -> {
                ...
                try {
                    ...
                    utils.saveLogs("Error", "Dog Stream", "Invalid JSON: missing required keys");
                }
            ...
            Utils utils = new Utils();
            utils.saveLogs("Error", "Dog Stream", "Connection error");
        }
    }
