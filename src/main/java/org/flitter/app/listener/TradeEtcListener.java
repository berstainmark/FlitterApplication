...
public class TradeEtcListener implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(ApplicationReadyEvent events) {
        ...
        try {
            client.tradeStream("etcusdt", ((event) -> {
                ...
                try {
                    ...
                    utils.saveLogs("Error", "ETC Stream", "Invalid JSON: missing required keys");
                }
            ...
            Utils utils = new Utils();
            utils.saveLogs("Error", "ETC Stream", "Connection error");
        }
    }
