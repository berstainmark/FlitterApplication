...
public class TradeEthListener implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(ApplicationReadyEvent events) {
        ...
        try {
            client.tradeStream("ethusdt", ((event) -> {
                ...
                try {
                    ...
                    utils.saveLogs("Error", "Eth Stream", "Invalid JSON: missing required keys");
                }
            ...
            Utils utils = new Utils();
            utils.saveLogs("Error", "Eth Stream", "Connection error");
        }
    }
