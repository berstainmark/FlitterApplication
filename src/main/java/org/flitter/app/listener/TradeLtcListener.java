...
public class TradeLtcListener implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(ApplicationReadyEvent events) {
        ...
        try {
            client.tradeStream("ltcusdt", ((event) -> {
                ...
                try {
                    ...
                    utils.saveLogs("Error", "Ltc Stream", "Invalid JSON: missing required keys");
                }
            ...
            Utils utils = new Utils();
            utils.saveLogs("Error", "Ltc Stream", "Connection error");
        }
    }
