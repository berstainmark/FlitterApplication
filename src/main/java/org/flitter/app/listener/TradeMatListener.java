...
public class TradeMatListener implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(ApplicationReadyEvent events) {
        ...
        try {
            client.tradeStream("maticusdt", ((event) -> {
                ...
                try {
                    ...
                    utils.saveLogs("Error", "Mat Stream", "Invalid JSON: missing required keys");
                }
            ...
            Utils utils = new Utils();
            utils.saveLogs("Error", "Mat Stream", "Connection error");
        }
    }
