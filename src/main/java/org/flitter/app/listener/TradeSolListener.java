...
public class TradeSolListener implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(ApplicationReadyEvent events) {
        ...
        try {
            client.tradeStream("solusdt", ((event) -> {
                ...
                try {
                    ...
                    utils.saveLogs("Error", "Sol Stream", "Invalid JSON: missing required keys");
                }
            ...
            Utils utils = new Utils();
            utils.saveLogs("Error", "Sol Stream", "Connection error");
        }
    }
