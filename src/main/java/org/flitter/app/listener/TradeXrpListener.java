...
public class TradeXrpListener implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(ApplicationReadyEvent events) {
        ...
        try {
            client.tradeStream("xrpusdt", ((event) -> {
                ...
                try {
                    ...
                    utils.saveLogs("Error", "Xrp Stream", "Invalid JSON: missing required keys");
                }
            ...
            Utils utils = new Utils();
            utils.saveLogs("Error", "Xrp Stream", "Connection error");
        }
    }
